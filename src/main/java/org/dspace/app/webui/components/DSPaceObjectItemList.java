...
class DSpaceObjectItemList
{
     ...
     */
    public static void process(Context context, HttpServletRequest request,
                               HttpServletResponse response, DSpaceObject dSpaceObject)
            throws PluginException, AuthorizeException
    {
        if (dSpaceObject != null && (dSpaceObject.getType() != Constants.COLLECTION) && dSpaceObject.getType() != Constants.COMMUNITY ) {
            throw new PluginException(new Exception("can not apply DSpaceObjectItemList to " + dSpaceObject));
        }
        ...
        try
        {
            ...
            scope.setBrowseContainer(dSpaceObject);
